 ...
 * @author BaoThanh
 */
public class VCH_THADServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("listvch", vanchuyen);
        request.setAttribute("listth", thanhtoan);

        request.getRequestDispatcher("admin/vchandth.jsp").forward(request, response);
