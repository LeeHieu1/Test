                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Danh sách các hình vận chuyển</h4>
                                        </div>
                                        <div class="content">  
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                <c:forEach items="${listvch}" var="vch" >
                                                    <tr>
                                                        <th scope="row">${vch.maVC}</th>
                                                        <td>${vch.tenVC}</td>
                                                        <td>${vch.gia}</td>
                                                        <td>${vch.moTa}</td>
                                                    </tr>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Danh sách các loại thanh toán</h4>
                                        </div>
                                        <div class="content">  
                                            <table class="table table-bordered">
                                                <thead class="thead-light">
