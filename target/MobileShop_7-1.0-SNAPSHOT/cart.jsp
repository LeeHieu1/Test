                                        ...
                                        <c:forEach items="${update}" var="sp">
                                            <tr class="cart_item">
                                                <td class="product-remove">
                                                    <a title="Remove this item" class="remove" href="cart?command=removecart&maSP=${sp.sanpham.maSP}">×</a> 
                                                </td>

                                                <td class="product-thumbnail">
                                                    <a href="single-product.jsp"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="${sp.sanpham.anh}"></a>
                                                </td>
                                                ...
                                                <td class="product-price">
                                                    <span class="amount">$${sp.sanpham.gia}</span> 
                                                </td>
                                                ...
                                                <td class="product-quantity">
                                                    <div class="quantity buttons_added">
                                                        ...
                                                        <form action="CartUpdate" method="post">
                                                            <a href="cart?command=deletecart&maSP=${sp.sanpham.maSP}" class="minus" >-</a>
                                                            <input type="text" size="2" class="input-text qty text" title="Qty" value="${sp.quantity}" disabled="disabled">
                                                            <a href="cart?command=addcart&maSP=${sp.sanpham.maSP}" class="plus">+</a>
...
<!--                                                <div class="coupon">
                                                ...
                                                <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" 
                                                   href="CheckServlet">Thanh toán</a>
                                            </td>
